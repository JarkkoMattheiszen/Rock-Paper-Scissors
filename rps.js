...
// AI enemy makes a choice. The AI kicks in after three rounds and looks for repeating patterns in player's history.
function enemyPlays() {
...
// Collection function to prevent repeating
function roundLogic() {
    enemyPlays();
